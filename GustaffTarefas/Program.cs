...
var conection = builder.Configuration.GetConnectionString("Notas");

builder.Services.AddDbContext<Context>(options => options.UseMySql(conection, Microsoft.EntityFrameworkCore.ServerVersion.Parse("3.0.38-mysql")));
